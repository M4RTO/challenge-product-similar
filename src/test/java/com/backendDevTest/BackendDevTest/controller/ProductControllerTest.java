...
public class ProductControllerTest {
    ...
    void getProductOk() throws Exception {
        ...
        when(productService.getSimilarProduct(any()))
                .thenReturn(CompletableFuture.completedFuture(MockFactory.getProducts()));

        final var result = mockMvc.perform(get(URL,"1")).andReturn();
    ...
    @Test
    @DisplayName("when getProductsSimilar is called, the controller should return Internal exception with 500")
    void getProductNotOkInternalException() throws Exception {
